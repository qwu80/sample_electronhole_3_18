class Vehicle{
    ...
    display(){
      ...
      fill(254,246,182, 100);
      stroke(254,246,182, 100);
    //   ellipse(this.position.x,((this.origin.x-4-this.botz*(8.8)*2*0.2)*s_y),5)
    //   ellipse(this.position.x,line_yellow_data[0].y-4,5)
    // ellipse(this.position.x,(line_yellow_data[99].y-this.botz*(8.8)*2*0.2)*s_y,5)
    ellipse(this.position.x,line_yellow_data[50].y-(this.botz*(8.8)*2*0.2)*s_y,5)
      ...
      this.position2.x=this.position.x
            ...
            if (sceneCount ==1.5) {
             ...
             if (this.origin.x == 0 && this.origin.y == 0) {
                ...
                this.position2.y=this.origin.y+4
                    ...
                    // if (this.near_index<50)  {
                        ...
                        if (parseInt(V_applied_p)>=0) {
                            ...
                            for (let i=0; i<100; i++){
                                ...
                                if (line_yellow_data[i]!= line_yellow_data[99]) {
                                    num_index = i
                                }

                            }

                            if (this.color ==0 && this.near_index<11 && this.position2.x > (line_yellow_data[this.near_index].x+E_gap_factor+10 )) {
                                this.direction.x = -2;
                            }
                        }
